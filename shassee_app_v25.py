...
st.set_page_config(
    page_title="شاصي تك | SHASSEE TECH v25",
    page_icon="⚙️",
    layout="wide",
...
if silver_car_b64:
    ...
    silver_car_html = '<svg viewBox="0 0 600 220" style="max-width: 480px; width: 100%; height: auto; margin-bottom: 20px; filter: drop-shadow(0 12px 24px rgba(16, 185, 129, 0.25));"> <defs> <!-- Sci-fi blueprint grid pattern --> <pattern id="grid" width="25" height="25" patternUnits="userSpaceOnUse"> <path d="M 25 0 L 0 0 0 25" fill="none" stroke="rgba(16, 185, 129, 0.04)" stroke-width="0.5"/> </pattern> <!-- Metallic Chrome gradient for the chassis parts --> <linearGradient id="chassis-chrome" x1="0%" y1="0%" x2="100%" y2="100%"> <stop offset="0%" stop-color="#FFFFFF" /> <stop offset="20%" stop-color="#E4E4E7" /> <stop offset="50%" stop-color="#A1A1AA" /> <stop offset="80%" stop-color="#52525B" /> <stop offset="100%" stop-color="#27272A" /> </linearGradient> <!-- Glowing emerald scanning laser beam --> <linearGradient id="laser-glow" x1="0%" y1="0%" x2="0%" y2="100%"> <stop offset="0%" stop-color="#10B981" stop-opacity="0.8"/> <stop offset="50%" stop-color="#34D399" stop-opacity="0.3"/> <stop offset="100%" stop-color="#059669" stop-opacity="0.0"/> </linearGradient> </defs><!-- Background Grid --> <rect width="600" height="220" fill="url(#grid)" rx="20" stroke="rgba(16, 185, 129, 0.15)" stroke-width="1"/><!-- AI Scanning Laser Beam --> <polygon points="120,10 480,10 400,210 40,210" fill="url(#laser-glow)" opacity="0.3" /> <line x1="120" y1="10" x2="40" y2="210" stroke="#10B981" stroke-width="3" stroke-linecap="round" stroke-dasharray="8 8" /> <line x1="480" y1="10" x2="400" y2="210" stroke="#10B981" stroke-width="3" stroke-linecap="round" stroke-dasharray="8 8" /><!-- Sleek 3D Vehicle Outlines (Aesthetic Background Silhouette) --> <path d="M 60,150 Q 80,70 180,65 T 320,60 T 460,75 Q 520,85 540,150" fill="none" stroke="rgba(255, 255, 255, 0.05)" stroke-width="2" /> <path d="M 120,110 C 160,110 180,95 240,95 C 300,95 350,100 400,110" fill="none" stroke="rgba(255, 255, 255, 0.05)" stroke-width="1" stroke-dasharray="4 4" /><!-- Detailed Steel Chassis Framework (No ladder look - actual automotive structure) --> <g transform="translate(20, 15)"> <!-- Main Left & Right Frame Rails with realistic structural bends --> <path d="M 80,135 L 140,120 L 380,120 L 440,135 Q 460,135 480,135" fill="none" stroke="url(#chassis-chrome)" stroke-width="8" stroke-linecap="round" stroke-linejoin="round" /> <path d="M 80,135 L 140,120 L 380,120 L 440,135 Q 460,135 480,135" fill="none" stroke="#27272A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><!-- Heavy Duty Suspension Crossmembers & Engine Cradle (Front & Rear mounts) --> <!-- Front suspension and steering rack detail --> <path d="M 130,123 L 130,90 L 155,90 M 130,105 L 175,105" fill="none" stroke="url(#chassis-chrome)" stroke-width="4" stroke-linecap="round" /> <circle cx="150" cy="115" r="5" fill="#10B981" /><!-- Rear Differential Housing (Axle Assembly) --> <circle cx="410" cy="130" r="12" fill="url(#chassis-chrome)" stroke="#3F3F46" stroke-width="2" /> <circle cx="410" cy="130" r="5" fill="#18181B" /> <line x1="370" y1="130" x2="450" y2="130" stroke="url(#chassis-chrome)" stroke-width="5" /><!-- Highly Detailed Mechanical Wheels (No robot eyes, actual sport spoke rims) --> <!-- Front Wheel --> <g transform="translate(130, 135)"> <!-- Outer Tire --> <circle cx="0" cy="0" r="32" fill="#090D16" stroke="url(#chassis-chrome)" stroke-width="5" /> <circle cx="0" cy="0" r="24" fill="#18181B" stroke="#3F3F46" stroke-width="1.5" /> <!-- Multi-spoke Rim Detail --> <circle cx="0" cy="0" r="14" fill="url(#chassis-chrome)" /> <line x1="0" y1="-24" x2="0" y2="24" stroke="#18181B" stroke-width="2" /> <line x1="-24" y1="0" x2="24" y2="0" stroke="#18181B" stroke-width="2" /> <line x1="-17" y1="-17" x2="17" y2="17" stroke="#18181B" stroke-width="1.5" /> <line x1="-17" y1="17" x2="17" y2="-17" stroke="#18181B" stroke-width="1.5" /> <circle cx="0" cy="0" r="5" fill="#18181B" stroke="#10B981" stroke-width="1.5" /> </g><!-- Rear Wheel --> <g transform="translate(410, 135)"> <!-- Outer Tire --> <circle cx="0" cy="0" r="32" fill="#090D16" stroke="url(#chassis-chrome)" stroke-width="5" /> <circle cx="0" cy="0" r="24" fill="#18181B" stroke="#3F3F46" stroke-width="1.5" /> <!-- Multi-spoke Rim Detail --> <circle cx="0" cy="0" r="14" fill="url(#chassis-chrome)" /> <line x1="0" y1="-24" x2="0" y2="24" stroke="#18181B" stroke-width="2" /> <line x1="-24" y1="0" x2="24" y2="0" stroke="#18181B" stroke-width="2" /> <line x1="-17" y1="-17" x2="17" y2="17" stroke="#18181B" stroke-width="1.5" /> <line x1="-17" y1="17" x2="17" y2="-17" stroke="#18181B" stroke-width="1.5" /> <circle cx="0" cy="0" r="5" fill="#18181B" stroke="#A1A1AA" stroke-width="1.5" /> </g><!-- Detailed Cab Mounts and Steel Brackets (For realism) --> <path d="M 180,120 L 180,105 L 195,105 M 260,120 L 260,105 L 275,105 M 340,120 L 340,105 L 355,105" fill="none" stroke="url(#chassis-chrome)" stroke-width="3" stroke-linecap="round" /><!-- Elegant Laser Scanning Line over the chassis --> <line x1="160" y1="50" x2="160" y2="170" stroke="#10B981" stroke-width="2.5" opacity="0.8" stroke-linecap="round" /> <circle cx="160" cy="120" r="4" fill="#FFFFFF" /> </g> </svg>'
