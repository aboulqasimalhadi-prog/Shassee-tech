...
st.set_page_config(
    page_title="شاصي تك | SHASSEE TECH v18",
    page_icon="⚙️",
    layout="wide",
...
# 🤖 Premium Silver Car Header (AI Era Rebranding - Completely Custom Glass Panel)
...
st.markdown(f'''
<div style="background: linear-gradient(135deg, rgba(13, 21, 39, 0.65) 0%, rgba(7, 9, 19, 0.85) 100%); 
    ...
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
        {silver_car_html}
        <h1 style="color: #FFFFFF; font-family: 'Cairo', sans-serif; font-weight: 900; font-size: 38px; margin-top: 10px; margin-bottom: 5px; text-shadow: 0 0 25px rgba(16, 185, 129, 0.45);">منصة شاصي تك | SHASSEE TECH</h1>
