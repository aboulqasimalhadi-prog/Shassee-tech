...
if silver_car_b64:
    ...
    # High-quality elegant SVG fallback of a luxury sports car side profile (completely safe from blank line collapses)
    silver_car_html = '<svg viewBox="0 0 600 180" style="max-width: 480px; width: 100%; height: auto; margin-bottom: 20px; filter: drop-shadow(0 12px 24px rgba(16, 185, 129, 0.2));">  <defs>    <pattern id="grid" width="20" height="20" patternUnits="userSpaceOnUse">      <path d="M 20 0 L 0 0 0 20" fill="none" stroke="rgba(16, 185, 129, 0.05)" stroke-width="0.5"/>    </pattern>    <linearGradient id="steel" x1="0%" y1="0%" x2="100%" y2="100%">      <stop offset="0%" stop-color="#FFFFFF" />      <stop offset="30%" stop-color="#E4E4E7" />      <stop offset="70%" stop-color="#71717A" />      <stop offset="100%" stop-color="#27272A" />    </linearGradient>    <linearGradient id="laser-glow" x1="0%" y1="0%" x2="100%" y2="0%">      <stop offset="0%" stop-color="#10B981" stop-opacity="0.8"/>      <stop offset="50%" stop-color="#34D399" stop-opacity="0.3"/>      <stop offset="100%" stop-color="#059669" stop-opacity="0.0"/>    </linearGradient>  </defs>  <rect width="600" height="180" fill="url(#grid)" rx="16" />  <g transform="translate(80, 15)">    <path d="M 50,110 L 400,30 L 400,40 L 50,120 Z" fill="url(#steel)" />    <path d="M 90,135 L 440,55 L 440,65 L 90,145 Z" fill="url(#steel)" />    <path d="M 50,110 L 90,135 L 90,141 L 50,116 Z" fill="url(#steel)" />    <path d="M 120,95 L 160,120 L 160,125 L 120,100 Z" fill="url(#steel)" />    <path d="M 200,77 L 240,102 L 240,107 L 200,82 Z" fill="url(#steel)" />    <path d="M 280,59 L 320,84 L 320,89 L 280,64 Z" fill="url(#steel)" />    <path d="M 350,42 L 390,67 L 390,72 L 350,47 Z" fill="url(#steel)" />    <path d="M 400,30 L 440,55 L 440,60 L 400,35 Z" fill="url(#steel)" />    <path d="M 110,87 L 130,83 L 130,93 L 110,97 Z" fill="url(#steel)" />    <path d="M 150,112 L 170,108 L 170,118 L 150,122 Z" fill="url(#steel)" />    <path d="M 360,35 L 375,31 L 375,41 L 360,45 Z" fill="url(#steel)" />    <path d="M 400,60 L 415,56 L 415,66 L 400,70 Z" fill="url(#steel)" />    <polygon points="180,10 320,10 240,150 100,150" fill="url(#laser-glow)" opacity="0.3" />    <line x1="200" y1="10" x2="120" y2="150" stroke="#10B981" stroke-width="4" stroke-linecap="round" />    <line x1="200" y1="10" x2="120" y2="150" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" />  </g></svg>'
    ...
    if selected_lot:
        ...
        with st.expander("🛠️ تخصيص وتعديل تفاصيل هذه السيارة يدوياً (لتطابق الرابط الفعلي تماماً):"):
            ...
            with col_ed1:
                ...
                edit_year = st.number_input("📅 سنة الصنع:", min_value=1990, max_value=2027, value=selected_lot["year"], key="edit_year_num")
            with col_ed2:
            ...
            with col_ed3:
                ...
                edit_bid = st.number_input("💵 سعر المزايدة الحالي ($):", min_value=500, max_value=30000, value=selected_lot["current_bid"], key="edit_bid_num")
