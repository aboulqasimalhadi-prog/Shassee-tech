...
st.set_page_config(
    page_title="شاصي تك | SHASSEE TECH v7",
    page_icon="🚗",
    layout="wide",
...
# 🚗 Application Header UI Upgrade (Sleek Text Header - Removed Logo from Main Body)
st.markdown("""
<div style="text-align: center; padding: 15px; margin-bottom: 25px; background: rgba(30, 58, 138, 0.1); border-radius: 16px;">
    ...
    <h3 style="color: #10B981; font-family: 'Cairo', sans-serif; font-weight: 600; margin-top: 0px;">التقييم الفني والمالي المستقل لسيارات المزادات الأمريكية</h3>
</div>
""", unsafe_allow_html=True)
