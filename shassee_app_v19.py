...
st.set_page_config(
    page_title="شاصي تك | SHASSEE TECH v19",
    page_icon="⚙️",
    layout="wide",
...
if silver_car_b64:
    ...
    silver_car_html = '<svg viewBox="0 0 600 160" style="max-width: 420px; width: 100%; height: auto; margin-bottom: 20px; filter: drop-shadow(0 8px 16px rgba(16, 185, 129, 0.35));"><path d="M50,110 C120,110 140,100 180,90 C220,80 270,70 330,70 C390,70 440,75 480,90 C510,100 530,110 550,110 C565,110 575,105 580,100 C570,90 550,75 510,65 C460,55 390,45 320,45 C250,45 180,55 130,65 C90,75 70,90 50,110 Z" fill="none" stroke="#D1D5DB" stroke-width="3" stroke-linecap="round"/><path d="M140,80 C180,80 210,65 260,65 C310,65 340,75 360,75 C380,75 410,65 440,75 C465,83 480,95 480,95" fill="none" stroke="#10B981" stroke-width="2" stroke-linecap="round"/><circle cx="170" cy="110" r="28" fill="#070913" stroke="#10B981" stroke-width="3"/><circle cx="170" cy="110" r="10" fill="#D1D5DB"/><circle cx="450" cy="110" r="28" fill="#070913" stroke="#10B981" stroke-width="3"/><circle cx="450" cy="110" r="10" fill="#D1D5DB"/><path d="M170,110 L450,110" stroke="#D1D5DB" stroke-width="3" stroke-dasharray="5,5"/></svg>'
...
def parse_auction_url(url):
    """
    Parses a Copart or IAAI URL.
    Attempts to extract metadata from the URL dynamically, providing a robust, free,
    no-API-key testing bridge for the founding period.
    """
