...
st.set_page_config(
    page_title="شاصي تك | SHASSEE TECH v21",
    page_icon="⚙️",
    layout="wide",
...
if silver_car_b64:
    ...
    silver_car_html = '<svg viewBox="0 0 600 180" style="max-width: 480px; width: 100%; height: auto; margin-bottom: 20px; filter: drop-shadow(0 12px 24px rgba(16, 185, 129, 0.25));">  <defs>    <pattern id="grid" width="20" height="20" patternUnits="userSpaceOnUse">      <path d="M 20 0 L 0 0 0 20" fill="none" stroke="rgba(16, 185, 129, 0.05)" stroke-width="0.5"/>    </pattern>    <linearGradient id="silver-metal" x1="0%" y1="0%" x2="100%" y2="100%">      <stop offset="0%" stop-color="#FFFFFF" />      <stop offset="50%" stop-color="#A1A1AA" />      <stop offset="100%" stop-color="#3F3F46" />    </linearGradient>    <linearGradient id="emerald-glow" x1="0%" y1="0%" x2="100%" y2="0%">      <stop offset="0%" stop-color="#10B981" stop-opacity="0.8"/>      <stop offset="100%" stop-color="#059669" stop-opacity="0.0"/>    </linearGradient>  </defs>  <rect width="600" height="180" fill="url(#grid)" rx="16" />  <path d="M 80,120 C 130,120 150,110 180,95 C 220,80 270,65 340,65 C 410,65 460,75 500,95 C 520,105 535,120 550,120" fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="2" stroke-linecap="round" />  <path d="M 120,95 C 160,85 200,50 280,50 C 350,50 390,60 440,75 C 470,85 490,95 500,95" fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="1.5" stroke-dasharray="4,4" />  <polygon points="260,10 420,10 320,160 160,160" fill="url(#emerald-glow)" opacity="0.25" />  <line x1="280" y1="10" x2="180" y2="160" stroke="#10B981" stroke-width="3" stroke-linecap="round" stroke-dasharray="10, 15" />  <line x1="300" y1="10" x2="200" y2="160" stroke="#34D399" stroke-width="2" stroke-linecap="round" />  <g transform="translate(10, 5)">    <path d="M 120,125 L 460,125" stroke="url(#silver-metal)" stroke-width="6" stroke-linecap="round" />    <path d="M 120,120 L 460,120" stroke="#E4E4E7" stroke-width="2" stroke-linecap="round" />    <rect x="150" y="90" width="70" height="30" rx="5" fill="none" stroke="url(#silver-metal)" stroke-width="2" />    <path d="M 160,100 L 210,100 M 160,110 L 210,110" stroke="#10B981" stroke-width="1.5" />    <path d="M 220,125 L 260,70 L 380,70 L 440,125" fill="none" stroke="url(#silver-metal)" stroke-width="3" stroke-linejoin="round" />    <path d="M 320,70 L 320,125" stroke="url(#silver-metal)" stroke-width="2" />    <path d="M 260,70 L 320,125 M 380,70 L 320,125" stroke="url(#silver-metal)" stroke-width="1.5" opacity="0.7" />    <line x1="245" y1="100" x2="265" y2="115" stroke="#D1D5DB" stroke-width="2" />    <ellipse cx="245" cy="95" rx="4" ry="12" fill="none" stroke="#10B981" stroke-width="2" transform="rotate(-20 245 95)" />    <path d="M 130,125 L 105,125 M 130,125 L 120,110" stroke="url(#silver-metal)" stroke-width="2.5" />    <path d="M 450,125 L 475,125 M 450,125 L 440,110" stroke="url(#silver-metal)" stroke-width="2.5" />    <circle cx="115" cy="125" r="28" fill="#070913" stroke="url(#silver-metal)" stroke-width="4" />    <circle cx="115" cy="125" r="16" fill="none" stroke="#10B981" stroke-width="2" />    <path d="M 115,97 L 115,153 M 87,125 L 143,125 M 95,105 L 135,145 M 95,145 L 135,105" stroke="rgba(255,255,255,0.4)" stroke-width="1" />    <circle cx="115" cy="125" r="6" fill="#A1A1AA" />    <circle cx="465" cy="125" r="28" fill="#070913" stroke="url(#silver-metal)" stroke-width="4" />    <circle cx="465" cy="125" r="16" fill="none" stroke="#10B981" stroke-width="2" />    <path d="M 465,97 L 465,153 M 437,125 L 493,125 M 445,105 L 485,145 M 445,145 L 485,105" stroke="rgba(255,255,255,0.4)" stroke-width="1" />    <circle cx="465" cy="125" r="6" fill="#A1A1AA" />  </g></svg>'
...
if integration_mode == "⚡ الوضع السحابي الحقيقي (Live Cloud)":
    ...
    st.sidebar.markdown("<hr style='border-color: rgba(255,255,255,0.05);'>", unsafe_allow_html=True)
    st.sidebar.subheader("🔌 ربط البيانات الحية (مجاني)")
    apibara_key = st.sidebar.text_input("🔑 مفتاح Apibara API (سحب مجاني):", type="password", help="أدخل مفتاحك المجاني من apibara.tech لسحب بيانات لوتات كوبارت وIAAI تلقائياً وصورها وحجم صدماتها!")
...
def parse_auction_url(url):
    ...
    location = random.choice(["Texas (Houston)", "California (Sacramento)", "New York (Long Island)", "Florida (Miami)", "Pennsylvania (Philadelphia)"])
    title = random.choice(["Salvage Title", "Clean Title", "Bill of Sale", "Certificate of Destruction"])
    current_bid = random.choice([3200, 4500, 5800, 2900, 6400])
    impact = random.choice(["أمامية يسار (Front-Left Impact)", "أمامية يمين (Front-Right Impact)", "خلفية (Rear Impact)", "جانبية (Side Impact)"])
